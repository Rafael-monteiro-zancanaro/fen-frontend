...
out='/nix/store/nbqxxfc0gxk9kyrw0pm6gd95cids7za3-devenv-shell-env'
export out
defaultBuildInputs=''
prefix='/nix/store/nbqxxfc0gxk9kyrw0pm6gd95cids7za3-devenv-shell-env'
READELF='readelf'
export READELF
cmakeFlags=''
export cmakeFlags
...
OBJCOPY='objcopy'
export OBJCOPY
nativeBuildInputs='/nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev /nix/store/yq0r544jcx32lhj7vk2xmx7hzkamdjmy-nodejs-slim-24.18.0-dev /nix/store/faqg3xyj1khsva1ds2ya1bqczamf1jjy-yarn-1.22.22 /nix/store/20kgcsdc05gb3jykggi43xhav6nmn8dj-typescript-language-server-5.3.0 /nix/store/swljvs2gz4mcb1avyjzb0cc2qrbslmbb-pkg-config-wrapper-0.29.2'
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/mp8s10fwm685azvvv1qq7zyf7iajjlj8-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/gqn8g1chjazaz4j7y8xyd3f6i9wc1y47-devenv-profile" ]
then
  ln -snf /nix/store/gqn8g1chjazaz4j7y8xyd3f6i9wc1y47-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
export shell
DEVENV_PROFILE='/nix/store/gqn8g1chjazaz4j7y8xyd3f6i9wc1y47-devenv-profile'
export DEVENV_PROFILE
outputDevdoc='REMOVE'
declare -a propagatedBuildDepFiles=('propagated-build-build-deps' 'propagated-native-build-inputs' 'propagated-build-target-deps' )
NIX_LDFLAGS='-rpath /nix/store/nbqxxfc0gxk9kyrw0pm6gd95cids7za3-devenv-shell-env/lib '
export NIX_LDFLAGS
...
exec /tmp/devenv-envCX0FR4/script 