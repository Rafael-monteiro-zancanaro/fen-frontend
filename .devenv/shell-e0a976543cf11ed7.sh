...
strictDeps=''
export strictDeps
DEVENV_RUNTIME='/run/user/1000/devenv-f9b8a3e'
...
STRIP='strip'
export STRIP
out='/nix/store/kz43wi3pjix01dhf1rg8nh9vjzq1b7ff-devenv-shell-env'
export out
preferLocalBuild='1'
...
NIX_CFLAGS_COMPILE=' -frandom-seed=kz43wi3pji -isystem /nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev/include -isystem /nix/store/yq0r544jcx32lhj7vk2xmx7hzkamdjmy-nodejs-slim-24.18.0-dev/include -isystem /nix/store/p8hbhn8hdqz5p3a7y6dvi1y1x8nriybl-nodejs-slim-24.18.0/include -isystem /nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev/include -isystem /nix/store/yq0r544jcx32lhj7vk2xmx7hzkamdjmy-nodejs-slim-24.18.0-dev/include -isystem /nix/store/p8hbhn8hdqz5p3a7y6dvi1y1x8nriybl-nodejs-slim-24.18.0/include'
export NIX_CFLAGS_COMPILE
NIX_LDFLAGS='-rpath /nix/store/kz43wi3pjix01dhf1rg8nh9vjzq1b7ff-devenv-shell-env/lib '
export NIX_LDFLAGS
...
outputInclude='out'
DEVENV_PROFILE='/nix/store/hamcb66kzfircs9sh38cxwd5bxj146n0-devenv-profile'
export DEVENV_PROFILE
cmakeFlags=''
export cmakeFlags
NODE_PATH='/nix/store/20kgcsdc05gb3jykggi43xhav6nmn8dj-typescript-language-server-5.3.0/lib/node_modules'
export NODE_PATH
LD='ld'
export LD
RANLIB='ranlib'
export RANLIB
DEVENV_STATE='/home/zancanaro/dev/tcc/fen-frontend/.devenv/state'
export DEVENV_STATE
OSTYPE='linux-gnu'
...
export name
DEVENV_ROOT='/home/zancanaro/dev/tcc/fen-frontend'
export DEVENV_ROOT
NIX_BINTOOLS_WRAPPER_TARGET_HOST_x86_64_unknown_linux_gnu='1'
export NIX_BINTOOLS_WRAPPER_TARGET_HOST_x86_64_unknown_linux_gnu
declare -a envTargetTargetHooks=()
outputDevdoc='REMOVE'
DEVENV_DOTFILE='/home/zancanaro/dev/tcc/fen-frontend/.devenv'
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/mp8s10fwm685azvvv1qq7zyf7iajjlj8-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/hamcb66kzfircs9sh38cxwd5bxj146n0-devenv-profile" ]
then
  ln -snf /nix/store/hamcb66kzfircs9sh38cxwd5bxj146n0-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
mkdir -p /run/user/1000/devenv-f9b8a3e
ln -snf /run/user/1000/devenv-f9b8a3e /home/zancanaro/dev/tcc/fen-frontend/.devenv/run


source /nix/store/hzd9m0qwddz3f4yghccbq4h0rjxi4ymk-init-yarn.sh

export PATH="node_modules/.bin:$PATH"

echo "✨ devenv 2.1.2 is out of date. Please update to 2.2.0: https://devenv.sh/getting-started/#installation" >&2


# Check whether the direnv integration is out of date.
{
  if [[ ":${DIRENV_ACTIVE-}:" == *":/home/zancanaro/dev/tcc/fen-frontend:"* ]]; then
...
prefix='/nix/store/kz43wi3pjix01dhf1rg8nh9vjzq1b7ff-devenv-shell-env'
nativeBuildInputs='/nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev /nix/store/yq0r544jcx32lhj7vk2xmx7hzkamdjmy-nodejs-slim-24.18.0-dev /nix/store/faqg3xyj1khsva1ds2ya1bqczamf1jjy-yarn-1.22.22 /nix/store/20kgcsdc05gb3jykggi43xhav6nmn8dj-typescript-language-server-5.3.0 /nix/store/y0k44j7p7dgijjyncacd39d6qpylqgdj-tailwindcss_3-3.4.17 /nix/store/swljvs2gz4mcb1avyjzb0cc2qrbslmbb-pkg-config-wrapper-0.29.2'
export nativeBuildInputs
DEVENV_TASK_FILE='/nix/store/sd8shf4vh51lcsb2x8kvszbsvy1186xp-tasks.json'
...
declare -a pkgsBuildHost=('/nix/store/f49m5fpswmw65qk15bpdg0nakn7ly4n1-bash-interactive-5.3p15-dev' '/nix/store/dddwfz7nph37q3cjky9lhpy9kb90rrrx-bash-interactive-5.3p15' '/nix/store/yq0r544jcx32lhj7vk2xmx7hzkamdjmy-nodejs-slim-24.18.0-dev' '/nix/store/p8hbhn8hdqz5p3a7y6dvi1y1x8nriybl-nodejs-slim-24.18.0' '/nix/store/faqg3xyj1khsva1ds2ya1bqczamf1jjy-yarn-1.22.22' '/nix/store/20kgcsdc05gb3jykggi43xhav6nmn8dj-typescript-language-server-5.3.0' '/nix/store/y0k44j7p7dgijjyncacd39d6qpylqgdj-tailwindcss_3-3.4.17' '/nix/store/swljvs2gz4mcb1avyjzb0cc2qrbslmbb-pkg-config-wrapper-0.29.2' '/nix/store/f13cgj4sypbjrwwpshfc2x4fd11is8dp-patchelf-0.15.2' '/nix/store/wkyl6bvcp2dcw1in5qhqrq1dbvrwi193-update-autotools-gnu-config-scripts-hook' '/nix/store/0y5xmdb7qfvimjwbq7ibg1xdgkgjwqng-no-broken-symlinks.sh' '/nix/store/cv1d7p48379km6a85h4zp6kr86brh32q-audit-tmpdir.sh' '/nix/store/85clx3b0xkdf58jn161iy80y5223ilbi-compress-man-pages.sh' '/nix/store/p3l1a5y7nllfyrjn2krlwgcc3z0cd3fq-make-symlinks-relative.sh' '/nix/store/5yzw0vhkyszf2d179m0qfkgxmp5wjjx4-move-docs.sh' '/nix/store/fyaryjvghbkpfnsyw97hb3lyb37s1pd6-move-lib64.sh' '/nix/store/kd4xwxjpjxi71jkm6ka0np72if9rm3y0-move-sbin.sh' '/nix/store/pag6l61paj1dc9sv15l7bm5c17xn5kyk-move-systemd-user-units.sh' '/nix/store/cmzya9irvxzlkh7lfy6i82gbp0saxqj3-multiple-outputs.sh' '/nix/store/x8c40nfigps493a07sdr2pm5s9j1cdc0-patch-shebangs.sh' '/nix/store/cickvswrvann041nqxb0rxilc46svw1n-prune-libtool-files.sh' '/nix/store/xyff06pkhki3qy1ls77w10s0v79c9il0-reproducible-builds.sh' '/nix/store/z7k98578dfzi6l3hsvbivzm7hfqlk0zc-set-source-date-epoch-to-latest.sh' '/nix/store/pilsssjjdxvdphlg2h19p0bfx5q0jzkn-strip.sh' '/nix/store/adcz0m6qq2flmshdf0zz2xwjr5zbq1gr-gcc-wrapper-15.3.0' '/nix/store/9q284bcg9jr5hd5537i7v9n2ngqm1dq8-binutils-wrapper-2.46' )
phases='buildPhase'
export phases
outputDoc='out'
outputDevman='out'
...
exec /tmp/devenv-envHBIpy0/script 